...
import { ElementaryErrorResult } from "@/react/components/codec/Format.Errors/types/elementary/elementary-error-result";
import { isArrayErrorResult } from "@/utils/type-guards/value-and-result/array";
import { ArrayErrorResult } from "@/react/components/codec/Format.Errors/interfaces/container/array-error-result";
import { isMappingErrorResult } from "@/utils/type-guards/value-and-result/mapping";
import { MappingErrorResult } from "@/react/components/codec/Format.Errors/interfaces/container/mapping-error-result";
...
import { TypeErrorResult } from "@/react/components/codec/Format.Errors/interfaces/special-container/type-error-result";
...
import { FunctionExternalErrorResult } from "@/react/components/codec/Format.Errors/interfaces/function/function-external-error-result";
import { isFunctionInternalErrorResult } from "@/utils/type-guards/value-and-result/function-internal";
import { FunctionInternalErrorResult } from "@/react/components/codec/Format.Errors/interfaces/function/function-internal-error-result";
import { OptionsErrorResult } from "@/react/components/codec/Format.Errors/interfaces/other/options-error-result";
