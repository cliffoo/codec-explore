...
import { ElementaryResult } from "@/react/components/codec/Format.Values/types/general/elementary-result";
...
import { MappingResult } from "@/react/components/codec/Format.Values/types/container/mapping-result";
import { isStructResult } from "@/utils/type-guards/value-and-result/struct";
import { StructResult } from "@/react/components/codec/Format.Values/types/container/struct-result";
...
import { MagicResult } from "@/react/components/codec/Format.Values/types/special-container/magic-result";
import { isTypeResult } from "@/utils/type-guards/value-and-result/type";
import { TypeResult } from "@/react/components/codec/Format.Values/types/special-container/type-result";
...
import { FunctionInternalResult } from "@/react/components/codec/Format.Values/types/function/function-internal-result";
import { OptionsResult } from "@/react/components/codec/Format.Values/types/special/options-result";
